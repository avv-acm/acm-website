...
export default function Navbar({ activeTab, setActiveTab, onJoinClick, user, onLogout }) {
  ...
  return (
    <nav className={`navbar glass-container ${hoveredItem ? 'navbar-hovered' : ''}`} onMouseLeave={() => setHoveredItem(null)}>
