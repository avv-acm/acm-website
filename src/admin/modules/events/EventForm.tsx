...
export default function EventForm({ event, onSuccess, onCancel }: EventFormProps) {
  ...
  // Resource Person & SIG Association
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (event) {
        await updateMutation({ id: event._id, ...payload });
      } else {
  ...
  return (
    <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
      ...
      <ImageUpload
        ...
        ratioText="Landscape banner recommended (16:9), max 2MB"
      />
      ...
      <div className="form-group">
        ...
        <input
          ...
          placeholder="AI & ML Hands-on Workshop"
          value={title}
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "16px" }}>
        <div className="form-group">
          ...
          <input
            type="text"
            className="form-input"
            placeholder="Main Seminar Hall / MS Teams"
            value={location}
      ...
      <div style={{ border: "1px solid var(--border)", borderRadius: "var(--radius-md)", padding: "16px", background: "rgba(255, 255, 255, 0.02)" }}>
        ...
        <ImageUpload
          value={rpImageUrl}
          onChange={setRpImageUrl}
          label="Speaker Image"
          ratioText="Square speaker photo recommended"
        />
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "16px", marginTop: "12px" }}>
          ...
          <div className="form-group">
            ...
            <input
              ...
              value={rpOrganization}
              onChange={(e) => setRpOrganization(e.target.value)}
            />
          </div>
        </div>
      </div>
      ...
      <div className="form-group">
        ...
        <textarea
          className="form-input"
          placeholder="Provide detailed information about the schedule, prerequisites, speakers..."
          value={description}
